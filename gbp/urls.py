...
urlpatterns = [
    ...
    #url(r'^ssrnai/percevejo/percevejo_results/', PercevejoResults.as_view(), name='percevejo_results'),
    url(r'^ssrnai/percevejo/percevejo_results/$', PercevejoResults.as_view(), name='percevejo_results'),
    ...
    url(r'^ssrnai/capim/capim_results/$', CapimResults.as_view(), name='capim_results'),
    ...
    url(r'^ssrnai/buva/buva_results/$', BuvaResults.as_view(), name='buva_results'),
    ...
    url(r'^ssrnai/lagarta/lagarta_results/$', LagartaResults .as_view(), name='lagarta_results'),
    ...
    url(r'^ssrnai/nematoide/nematoide_results/$', NematoideResults.as_view(), name='nematoide_results'),
