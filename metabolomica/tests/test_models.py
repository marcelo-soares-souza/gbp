...
from metabolomica.models import Sample, Approach, Equipment, MsMode, Result, Species, Formula, Analytical
...
class MsModeModelTest(TestCase):

    def test_ms_mode_name(self):
        ms_mode = MsMode(name="MS Mode")
