...
class ContratoForm(forms.ModelForm):
    ...
    class Meta:
        model = Contrato
        fields = ('numero', 'projeto', 'empresa_executora', 'status_contrato', 'status_pagamento', 'data_contratacao', 'status_cgen', 'ttm', 'contato_gestor', 'codigo_pedido_gestor', 'objetivo', 'descricao')
