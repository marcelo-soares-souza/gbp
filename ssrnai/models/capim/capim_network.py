...
class Capim_Network(models.Model, TemplateModelMixin):

    organism = models.ForeignKey(Organisms("organism_id"), null=True, blank=True, on_delete=models.SET_NULL)
    gene1 = models.ForeignKey(Capim_Gene_Information("gene_id"), related_name='gene1', null=True, blank=True, on_delete=models.SET_NULL)
    gene2 = models.ForeignKey(Capim_Gene_Information("gene_id"), related_name='gene2', null=True, blank=True, on_delete=models.SET_NULL)
