...
class BuvaDatabaseSearch(LoggedInMixin, DetailView):
    template_name = 'buva/buva_database_search.html'
    context_object_name = 'database'
    model = Database
    fields = '__all__'

    def get_context_data(self, **kwargs):
        context = super(BuvaDatabaseSearch, self).get_context_data(**kwargs)
