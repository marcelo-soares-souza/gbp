...
class CapimDatabaseSearch(LoggedInMixin, DetailView):
    template_name = 'capim/capim_database_search.html'
    context_object_name = 'database'
    model = Database
    fields = '__all__'

    def get_context_data(self, **kwargs):
        context = super(CapimDatabaseSearch, self).get_context_data(**kwargs)
