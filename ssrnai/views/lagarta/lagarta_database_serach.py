...
class LagartaDatabaseSearch(LoggedInMixin, DetailView):
    template_name = 'lagarta/lagarta_database_search.html'
    context_object_name = 'database'
    model = Database
    fields = '__all__'

    def get_context_data(self, **kwargs):
        context = super(LagartaDatabaseSearch, self).get_context_data(**kwargs)
