...
class NematoideResults(DetailView):
    ...
    template_name = 'nematoide/nematoide_results.html'
    paginate_by = 10
    context_object_name = 'page_obj'
    fields = '__all__'

    success_url = reverse_lazy('nematoide_results')
    ...
    def get(self, request):
        ...
        return render(request, 'nematoide/nematoide_results.html', { 'results': results })    
