...
class PercevejoDatabaseSearch(LoggedInMixin, DetailView):
    template_name = 'percevejo/percevejo_database_search.html'
    context_object_name = 'database'
    model = Database
    fields = '__all__'

    def get_context_data(self, **kwargs):
        context = super(PercevejoDatabaseSearch, self).get_context_data(**kwargs)
